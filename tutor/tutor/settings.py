...
SECRET_KEY = 'django-insecure-lj1ir@vrorw8*@6$za+od0lzb$glra=t+_=5#11kxwd_-xgp&u'
...
DATABASES = {
   'default': {
       ...
       'HOST': 'localhost',
       'PORT': '5432',
       # superuser - vivek and password - #Vivek2002 for seeing the data that stored in this project
   }
}
